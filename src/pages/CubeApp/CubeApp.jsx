...
import { SubShare } from "../../components/SubShare/SubShare";
      ...
      <div className="container">
        <section className={`cube-app ${lng}`}>
            ...
            <form className="edit-form" id="edit-form" onSubmit={handleSubmit}>
              ...
              <div className="edit-container">
                <div className="flex gap-05-rem align-center">
                  ...
                  />
                  <i
                    onClick={() => onColorsEdit("front")}
                    className="fas fa-palette"
                  ></i>
                  <button
                    className="preview-btn"
                    onClick={() => onPreview("front")}
                  >
                    {t("preview.title")}
                  </button>
                </div>
                <div className={`color-pickers flex gap-1-5rem`}>
                  <div className="color-edit-front">
                    <div className="flex gap-02-rem align-center">
                      ...
                      />
                      <button onClick={() => onDefaultBackground("front")}>
                        {t("default.title")}
                      </button>
                    </div>
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultTxt("front")}>
                        {t("default.title")}
                      </button>
                    </div>
                  </div>
              ...
              <div className="edit-container">
                <div className="edit-btns flex gap-05-rem align-center">
                  ...
                  />
                  <i
                    onClick={() => onColorsEdit("back")}
                    className="fas fa-palette"
                  ></i>
                  <button
                    className="preview-btn"
                    onClick={() => onPreview("back")}
                  >
                    {t("preview.title")}
                  </button>
                </div>
                  ...
                  <div className="color-edit-back">
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultBackground("back")}>
                        {t("default.title")}
                      </button>
                    </div>
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultTxt("back")}>
                        {t("default.title")}
                      </button>
                    </div>
                  </div>
              ...
              <div className="edit-container">
                <div className="edit-btns flex gap-05-rem align-center">
                  ...
                  />
                  <i
                    onClick={() => onColorsEdit("right")}
                    className="fas fa-palette"
                  ></i>
                  <button
                    className="preview-btn"
                    onClick={() => onPreview("right")}
                  >
                    {t("preview.title")}
                  </button>
                </div>
                  ...
                  <div className="color-edit-right">
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultBackground("right")}>
                        {t("default.title")}
                      </button>
                    </div>
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultTxt("right")}>
                        {t("default.title")}
                      </button>
                    </div>
                  </div>
              ...
              <div className="edit-container">
                <div className="edit-btns flex gap-05-rem align-center">
                  ...
                  />
                  <i
                    onClick={() => onColorsEdit("left")}
                    className="fas fa-palette"
                  ></i>
                  <button
                    className="preview-btn"
                    onClick={() => onPreview("left")}
                  >
                    {t("preview.title")}
                  </button>
                </div>
                  ...
                  <div className="color-edit-left">
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultBackground("left")}>
                        {t("default.title")}
                      </button>
                    </div>
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultTxt("left")}>
                        {t("default.title")}
                      </button>
                    </div>
                  </div>
              ...
              <div className="edit-container">
                <div className="edit-btns flex gap-05-rem align-center">
                  ...
                  />
                  <i
                    onClick={() => onColorsEdit("top")}
                    className="fas fa-palette"
                  ></i>
                  <button
                    className="preview-btn"
                    onClick={() => onPreview("top")}
                  >
                    {t("preview.title")}
                  </button>
                </div>
                  ...
                  <div className="color-edit-top">
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultBackground("top")}>
                        {t("default.title")}
                      </button>
                    </div>
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultTxt("top")}>
                        {t("default.title")}
                      </button>
                    </div>
                  </div>
              ...
              <div className="edit-container">
                <div className="edit-btns flex gap-05-rem align-center">
                  ...
                  />
                  <i
                    onClick={() => onColorsEdit("bottom")}
                    className="fas fa-palette"
                  ></i>
                  <button
                    className="preview-btn"
                    onClick={() => onPreview("bottom")}
                  >
                    {t("preview.title")}
                  </button>
                </div>
                  ...
                  <div className="color-edit-bottom">
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultBackground("bottom")}>
                        {t("default.title")}
                      </button>
                    </div>
                    <div className="flex gap-02-rem align-center">
                      ...
                      <input
                        ...
                        onChange={onColorChange}
                      />
                      <button onClick={() => onDefaultTxt("bottom")}>
                        {t("default.title")}
                      </button>
                    </div>
                  </div>
              ...
              <div className="save-clear-btns">
                <button className="clear-btn" onClick={() => clearCube()}>
                  <i className="far fa-trash-alt"></i>
                </button>
                <button className="save-btn" onClick={() => saveCube(cube)}>
          ...
          <div className="roll-cube-btn">
            <button className="roll-btn" onClick={() => rollCube()}>
              {t("roll.title")}
            </button>
          </div>
